...
class TestTrader(unittest.TestCase):
    ...
    def test_start_buying_on_turnaround(self):
        ...
        self.assertEqual(self.trader.depot, {6000_00:  0.016666666666666666})
        self.assertEqual(self.trader.money, 900_00)
